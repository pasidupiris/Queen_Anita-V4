...
global.ownername = process.env.OWNER_NAME || "GAMING PASIYA";
global.packname = process.env.PACK_NAME || "𝐐𝐔𝐄𝐄𝐍_𝐀𝐍𝐈𝐓𝐀-𝐕𝟒";
global.author = process.env.AUTHOR || "GAMING PASIYA";
global.channelname = process.env.CHANNEL_NAME || "GAMING PASIYA";
